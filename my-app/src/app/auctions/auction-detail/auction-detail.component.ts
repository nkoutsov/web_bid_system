...
export class AuctionDetailComponent implements OnInit {
  ...
  getAuction() {
    ...
    this.auctionService.getAuction(id).subscribe(auction => {
      ...
      let lonlat = this.mapService.getLatLon(this.auction.location, this.auction.country)//.pipe(lonlat => {
      //   if(lonlat){
      // localStorage.setItem('longitude',lonlat.longtitude);
      // localStorage.setItem('latitude',lonlat.latitude);
      //   }
      } )
  }
